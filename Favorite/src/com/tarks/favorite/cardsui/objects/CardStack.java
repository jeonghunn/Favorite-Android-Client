...
import com.tarks.favorite.cardsui.StackAdapter;
import com.tarks.favorite.cardsui.SwipeDismissTouchListener;
import com.tarks.favorite.cardsui.Utils;
import com.tarks.favorite.cardsui.SwipeDismissTouchListener.OnDismissCallback;
		...
		return new AnimatorListener() {
			...
			public void onAnimationStart(Animator animation) {
				if (index == 0) {
					...
					clickedCard
							.setBackgroundResource(com.tarks.favorite.R.drawable.card_background);
				}
