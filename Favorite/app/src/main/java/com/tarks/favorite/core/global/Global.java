...
public final class Global {
	...
	public static String GCMReg(Context cx) {
//          if (checkPlayServices()) {
        GoogleCloudMessaging gcm = GoogleCloudMessaging.getInstance(cx);
        String regid = getRegistrationId(cx);

        if (regid.isEmpty()) {
            registerInBackground(cx);

    } else {
     Global.log("No valid Google Play Services APK found.");
    }
   ...
   final String PROPERTY_REG_ID = "REGID";
        final SharedPreferences prefs = getGCMPreferences(context);
        String registrationId = prefs.getString(PROPERTY_REG_ID, "");
        if (registrationId.isEmpty()) {
           Global.log("Registration not found.");
            return "";
        }
        ...
        if (registeredVersion != currentVersion) {
          Global.log( "App version changed.");
            return "";
        }
    ...
    public static SharedPreferences getGCMPreferences(Context context) {
        ...
        return mod.getSharedPreferences("GCM",
        ...
        new AsyncTask() {
            ...
            protected Object doInBackground(Object[] params) {
                ...
                try {
                    ...
                    String regid = gcm.register("743824910564");
    ...
    public static void storeRegistrationId(Context context, String regId) {
       ...
       Global.log( "Saving regId on app version " + appVersion);
